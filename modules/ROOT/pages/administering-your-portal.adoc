...
Administers can enable users to self-register for access to the portal. When this feature is enabled, users can sign up to access the portal.
...
. From the Builder, go to *Setup* and search for *All Sites* in the quick find.
