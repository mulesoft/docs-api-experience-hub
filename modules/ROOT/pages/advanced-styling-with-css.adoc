...
=== API Carousel
This component is in the home page. The API Carousel shows the API cards as a carousel with a maximum of five assets.
...
It shows pages from an asset. This pages are requested fromm Exchange.
...
=== Asset Detail Header
(Public component) This component is in API detail page. It shows basic information about an asset (logo, name, asset type, information contact, combobox version, status, instances, clients, spec download, and request access button)
