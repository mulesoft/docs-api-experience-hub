...
If the required information is not in the supported format, create a new custom attribute. For information, see the documentation for the identity provider. 
