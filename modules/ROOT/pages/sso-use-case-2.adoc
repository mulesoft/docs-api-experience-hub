...
* The user or identity the group of the users who have access to the application have been created in the identity provider. 
...
== Map the Identity Provider with Anypoint
...
. Paste the ID into the new anypoint_idp_id attribute. The ID must in quotes.
