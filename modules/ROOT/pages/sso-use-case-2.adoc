...
* Read the information in the xref:enabling-sso-for-your-portal.adoc#before-you-begin [Before You Begin] section to understand the roles and permissions required and the information that API Experience Hub expects to configure custom user attributes and claims for the identity provider.
...
+
For example, for OpenID Connect, you can configure the groups claims using the following steps:
