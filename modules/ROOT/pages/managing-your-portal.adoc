...
After your portal is styled using the guided design, the *Manage your API portal* page provides options to manage APIs, users, settings, environments, and surfaces issues that occur while managing the portal.
...
+ 
Manage separate deployment environments for your API portal. You can connect to multiple Salesforce sandbox organizations and switch between them.
