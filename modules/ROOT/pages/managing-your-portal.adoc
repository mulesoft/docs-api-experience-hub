...
image::aeh-api-management.png[API Management]
...
You can view the description of an API by clicking the down arrow in front of the API name in the list:
...
Curate your portal in API Experience Hub by adding APIs from Exchange. When adding APIs to the portal, the default visibility is Administrator only. You can change the visibility to include members or everyone. See xref:make-api-versions-visible.adoc[Make API Versions Visible] for more information.
...
== Next Steps
From API Management, you can further customize your portal using Experience Builder. To open the Builder, click *Preview Portal in Salesforce Builder*.
