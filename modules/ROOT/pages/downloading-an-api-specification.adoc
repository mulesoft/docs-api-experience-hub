...
A copy of an API specification can be downloaded from the service details page by clicking *Download*.
...
* GraphQL
+
Downloads as .json schema file.

* gRPC
+
Downloads as a .proto type file.
