...
You can download a copy of an API specification from the API Details page by clicking *Download*.
...
* GraphQL
+
Downloads as a .json schema file.

* gRPC
+
Downloads as a .proto file.
