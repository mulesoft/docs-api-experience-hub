...
Important! Please ensure that you are linking your AnyPoint organization to the correct Salesforce organization. Currently, this connection can only be done once. Once the connection is made, you cannot unlink from that Salesforce organization. 
...
The licenses for the pilot within the Salesforce Organization and AnyPoint Organization are free and expire on December 31, 2022. After this date, you cannot access the API portal or make changes. 

== Before You Begin

Before you can deploy your portal, ensure that you have:
...
+
The process of installing the Salesforce Experience Cloud package begins.

=== Next Steps
When the installation is complete, click Create your API Portal to begin creating your API portal.
