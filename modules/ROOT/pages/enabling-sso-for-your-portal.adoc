...
* xref:configuring-sso.adoc#step-1-enable-sso-for-your-portal[]
+
...
* xref:configuring-sso#step-2-add-salesforce-identity-providers[]
+
...
* xref:configuring-sso.adoc#add-group-mapping[]
+
...
* xref:configuring-sso.adoc#test-sso[]
+
...
* xref:user-roles-permissions-and-profiles.adoc#user-roles-for-configuring-sso[]
