...
* xref:sso-use-case-1.adoc[Use Case 1: Configuring Single Sign-On When No Identity Provider is Already Configured] 
* Use Case 2: An Identity Provider is Already Configured for Anypoint and Salesforce and Usernames Match
* Use Case 3: An Identity Provider is Already Configured for Anypoint and Salesforce but Usernames Do Not Match
