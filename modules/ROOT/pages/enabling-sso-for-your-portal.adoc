...
images::aeh-sso-flow2.png[Enabling SSO flowchart] 
...
The following steps require you to move back and forth between the application and the identity provider application to copy or add information.
