...
==== Create and Configure an Application Using SAML
Create a new application for the API Experience Hub portal in the identity provider using SAML. For detailed steps, see the documentation for Okta.
...
* User Profiles & Type: Ramses Guzmán Nicolás Mouso What do you enter here?
...
* Identity Provider Certificate: Ramses Guzmán Nicolás Mouso What do you enter here?
* Identity Provider Login URL: Ramses Guzmán
...
. For the Single Logout Request Binding field, select HTTP POST and click Save.
