...
|===
+ 
The following information is optional and enable you to configure specific use cases like xref:sso-use-case-2.adoc[Configuring SSO When the Identity Provider Is Already Configured for Anypoint Platform]:
+
