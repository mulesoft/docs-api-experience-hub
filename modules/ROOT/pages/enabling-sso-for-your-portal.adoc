...
image::aeh-sso-flow2.png["A diagram of the steps and applications to configure SSO."] 
...
* anypoint_idp_id
+
The custom claim or SAML attribute provides the information that's received from the identity provider that determines which Anypoint Platform identity provider a user must be mapped to.
