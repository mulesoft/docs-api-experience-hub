...
Ensure that you enter the correct information during this setup or end users cannot use the identity provider as a login option. For more information, see  xref:troubleshoot-sso-errors.adoc[].
