...
|===
. Verify that your identity provider sends the expected claims that is listed in the   xref:enabling-sso-for-your-portal.adoc#before-you-begin[Before You Begin] section. 
