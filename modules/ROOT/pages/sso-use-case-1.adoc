...
+
image::aeh-sso-view-saml-setup-instructions.png[View SAML setup instructions button,10%,10%]
+
You need the following information from this page to configure the Single Sign-on Settings tab in Salesforce:
+
