...
* Ensure that you read the information in Before You Begin to understand the roles and permissions required and what information API Experience Hub requires to configure custom user attributes and claims for the identity provider.
