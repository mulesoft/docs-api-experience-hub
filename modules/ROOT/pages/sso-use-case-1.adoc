...
+
The example IDs 00gdkat3p5RCvkQQC5d7, and 00gdjgk337kYDxtE35d7 correspond to the groups that you want to send. Ensure that you send all Anypoint Platform groups when you are configuring Okta in both Salesforce and Anypoint Platform. Otherwise, the user can lose access.
. Click *Next*.
