...
If the required information is not in the supported format, create a new attribute with a supported format. For information, see the documentation for the identity provider. 
