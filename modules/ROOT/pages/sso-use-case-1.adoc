...
+
. Review the xref:enabling-sso-for-your-portal.adoc#before-you-begin[Before You Begin] section to verify that your identity provider sends the expected claims.
+
For example, for OpenID Connect for Okta, you can configure the groups claim by:
