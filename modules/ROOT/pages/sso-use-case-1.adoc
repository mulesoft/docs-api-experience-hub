= Configuring Single Sign-On When No Identity Provider Is Configured in Anypoint Platform
...
+
If you are not using OpenID Connect, review the xref:enabling-sso-for-your-portal.adoc#before-you-begin[Before You Begin] section for the values that API Experience expects for claims and attributes and the documentation for the identity provider. 
...
. Review the xref:enabling-ss0-for-your-portal#before-you-begin[Before You Begin] section for information about what API Experience Hub expects for attributes to properly map users in the identity provider.
