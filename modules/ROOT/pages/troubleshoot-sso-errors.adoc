...
* Tou make changes to *Single Sign-On Settings* page without uploading the SSO certificate. 
+
...
+
To troubleshoot this issue, make sure you have the expected claims configured in the application. For more information, see xref:gathering-set-up-information-for-sso.adoc# required-claims-and-attributes-for-sso[Required Claims and Attributes for SSO].
