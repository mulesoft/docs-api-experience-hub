...
+
. Ensure the *Entity ID* is the same in both the Salesforce Auth. Provider's *Single Sign-On Settings* page and the identity provider. 
+
...
+
To troubleshoot this issue, ensure you upload the SSO certificate each time you change the *Single Sign-On Settings* page in Salesforce.
...
* Ensure the member is assigned to a user or a group in the identity provider application.
