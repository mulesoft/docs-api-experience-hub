...
This issue can also occur if you make changes to the *Single Sign-On Settings* page and do not upload the SSO certificate. When making changes, ensure you always upload the certificate.
