...
+
To troubleshoot this issue, follow the instructions in the Salesforce article, https://help.salesforce.com/s/articleView?id=005316413&type=1[API Experience HUb - Salesforce Users Unable to Log In to API Experience Hug Uisng JIT-Provisioned SSO] to fix the issue.
