...
+
You can have a maximum of 250 APIs in your portal.
...
== Manage API Versions Visible
You can determine which version of an API a user can view in your portal. You can set the visibility to Administrators, Members, Everyone, None.
