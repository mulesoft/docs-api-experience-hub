...
All administrators are automatically assigned the Exchange Viewer permission for all the services that have been added to your portal. Administrators can add only those services for which they have Exchange Viewer permission. For more information, see xref:assigning-permissions.adoc[]. 
