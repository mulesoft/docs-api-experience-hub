...
Existing admin users can have a maximum of 350 APIs in your portal. If you opt in to scale the portal, the maximum of APIs is 1,000.

New admin users are automatically opted in. 
