...
You can view information about an service directly from Exchange to determine whether you want to add the service in your portal.
...
. To search for an service by name or description, enter the name or description into the *Search* bar.
. To filter services by categories and tags, select an option from the *Any category* or *Any tag* dropdown and click *Apply*.
