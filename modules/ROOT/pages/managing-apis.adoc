...
. Locate teh API in the list, click the + (Add to the portal) icon.
+
...
. Locate the API in the list and click the trash can (Remove from the portal) icon.
. Click *Confirm*.
+
...
You can manage which version of an API a user can view in your portal. You can set the visibility to Administrators, Members and user groups, Everyone, or None.
...
If the visibility is Everyone, Members, or user groups, then consumer developers can see the new API version in the API Carousel of the portal.
...
. Expand an API version and select the users you want to see the API.
. Click *Save*.
