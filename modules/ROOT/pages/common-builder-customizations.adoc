...
. From a *Manage your API Portal* page, click *Preview and publish your portal* to open the Builder.
...
== Edit the Background Theme of the Login Page
You can change the color of the login page.
...
. in Branding OPtions, Logo File, Choose a file
