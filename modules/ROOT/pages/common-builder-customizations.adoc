...
|Record ID
|The feed item ID. Typically, this field is automatically populated when the page loads. Leave this field blank if you pick the *Discussion* or *My Feed options* in *Feed Type*.
|Default Filter
