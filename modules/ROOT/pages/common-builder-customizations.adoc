...
== Edit the API Carousel Titles and the Number of Cards to Display
You can edit the title and subtitle that appears for the API Carousel and the number of API asset cards that display.
...
. If you want to change the title, enter a name in the *Title* field.
. If you want to change the subtitle, enter a name in the *Subtitle* field.
. If you want to change the number of cards that display, select a number from three to fifteen from the list. 
