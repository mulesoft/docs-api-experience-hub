...
Configure the Chatter Feed component. The Feed component displays a feed of all record or group interactions, including posts, questions, system updates, and attachments.
