...
You can edit the number of API asset cards that display in the API Carousel. The API Carousel can display a minimum of three cards and a maximum of fifteen cards.
