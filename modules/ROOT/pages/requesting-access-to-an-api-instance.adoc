...
== Before You Begin
Before you can request access to a service, you must be a member user and be logged into the portal. See xref:registering-for-access-to-portal.adoc[Registering for Access to a Portal]
