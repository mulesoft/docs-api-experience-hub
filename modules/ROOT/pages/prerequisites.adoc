...
Anypoint Platform comes with predefined permissions that can be set in the Access Management to provide users with different access levels. You can configure the permissions for administrators and Exchange viewers.
...
Only the Organization Administrator can grant a user the API Experience Hub Administrator permission. Grant this permission when you want another user in your organization to perform the Salesforce linking process, create, curate, manage the portal, and manage users.
...
Once an API is added to the API portal by either the API Experience Hub Administrator and the Portal Administrator, all admins can view the API in the portal regardless of their access to specific APIs.
