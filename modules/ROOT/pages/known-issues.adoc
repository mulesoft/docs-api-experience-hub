...
* Images uploaded from the guided design may not render correctly if they extend the maximum size for height and width. For more information about size limits for images, see https://help.salesforce.com/s/articleView?id=sf.networks_enable_file_limits.htm&type=5[Limit Files in Your Experience Cloud Site].
...
+
To access API Experience Hub from a different Anypoint account, assign the API Experience Hub Admin permission from the main org to your chosen user account.
