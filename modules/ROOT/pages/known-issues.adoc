...
* The `Local` and `Language` for the user's personal settings must be set to *English*. For more information, see https://help.salesforce.com/s/articleView?id=sf.usersetup_lang_time_zone.htm&type=5[Edit Your Language and Locale Settings].

* An error occurs when changing the visibility of an API to *Members Only*.