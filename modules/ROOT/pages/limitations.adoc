...
* If scalability is enabled on the *API management* page, an API portal can have a maximum of 1,000 APIs. After this option is enabled, you can't revert to the portal version that supports up to 350 APIs.
+ 
