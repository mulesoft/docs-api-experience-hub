...
* If scalability is enabled on the *API management* page, an API portal can have a maximum of 1,000 APIs. Once this option is enabled, you can't revert to the portal version supporting the maximum of 350 APIs.
+ 
