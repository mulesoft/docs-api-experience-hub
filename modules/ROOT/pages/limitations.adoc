...
+
We do not recommend making changes to the permissions of the out-of-the-box Teams created in Access Management for API Experience Hub. Each asset added to the API portal uses two permissions and Access Management has a limit of 1000 permissions per team.
...
* IP restrictions are not supported. For more information, see the xref:troubleshooting.adoc[Troubleshooting] section for a workaround.
