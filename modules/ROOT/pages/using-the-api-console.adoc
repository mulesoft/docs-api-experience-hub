...
The API Console is an interactive component that shows information about REST APIs and their methods, and enables you to test the methods by sending requests. The API Console is located in the Service Details page. Endpoints are displayed in alphabetical order.
...
. On the *Home* or the *Services* page, select an API.
...
* xref:simulating-api-calls-using-the-mocking-service.adoc[e]
