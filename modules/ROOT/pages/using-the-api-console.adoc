...
The API Console displays the API specifications and documentation information that are critical to the onboarding process and adoption. Developers need to know how to use and integrate APIs. 
...
. In the *Home* or the *APIs* page, select an API.
