...
Use the *Enable portal access* slider to 
...
When a user's access to the portal is approved in the *Pending registration requests* page, the *Enable portal access* slider is enabled in the *Portal members* page. You can disable a user's access by moving the slider to off.
...
When the registration is approved, the user is removed from the list on Pending registration requests* page and added to the list of members on the *Portal members* page. 
