...
Users can self-register for your portal by default. View and manage users, access requests from guest users, and manage how users login.
...
. From the *User management*, click *Pending requests*.
...
To disable external user registration, from the *Login settings* of the *Manage your API portal* page, turn off the *Allow external user registration* option. 
