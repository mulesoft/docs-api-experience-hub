...
NOTE: * Self-registration is for new users only. Existing users cannot self-register.
...
=== Single Sign-On (SSO)
The *Single sign-on (SSO)* section provides  information about how to set up your portal with SSO. For detailed instructions, see xref:enabling-sso-for-your-portal.adoc[Enabling Single Sign-On for Your Portal]
