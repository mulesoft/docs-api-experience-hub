...
View and manage users, access requests from guest users, create and manage user groups, and manage how users login. By default, users can self-register for your portal. 
...
For users of a user group to log in to your portal using SSO, map the user group to an existing external identity provider. To avoid login issues, ensure you use the same group name and identity provider name configured for the identity provider. 
