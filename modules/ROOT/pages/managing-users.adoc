...
Use the *Pending registration requests* page to approve or reject requests for users who registered to access the portal. You can also view the user's name, email, registration date, and registration status of the users who register for access the portal. The maximum pending user registration requests is 500.
...
. Select an option from *Assign to*.
