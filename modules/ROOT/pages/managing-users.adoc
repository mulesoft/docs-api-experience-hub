...
For users of a user group to log in to your portal using SSO, map the user group to an existing external identity provider. To avoid login issues, ensure that you use the same group name and identity provider name configured for the identity provider. 
