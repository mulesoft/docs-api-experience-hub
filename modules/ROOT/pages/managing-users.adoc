...
=== Single Sign-On (SSO)
The *Single sign-on (SSO)* section provides you information about how to set up your portal with SSO. For more information, see xref:enabling-sso-for-your-portal.adoc[Enabling Single Sign-On for Your Portal]
