...
. Click the down arrow and select *Manage Members*. 
. In the *Manage Library Members* page, click the down arrow and select *People*.
+
The *Add Members* field shows the *search people* box.
. Click in the *search people* box and select *Builder Preview*.
. In *Access*, select *Author*. 
...
. Close the page.
+
. Confirm that you can see the library images in the Builder. 
