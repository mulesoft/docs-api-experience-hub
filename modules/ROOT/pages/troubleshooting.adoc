...
== Report an Issue
Follow these steps to report an issue with API Experience Hub:

. In a Slack channel, click the lightning bolt icon (image:aeh-blue-lightning-bolt.png[Lightning bolt icon])..
