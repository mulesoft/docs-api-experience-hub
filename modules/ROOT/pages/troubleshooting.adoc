...
.. Click *New* and enter *Bypass Account Validation Rule* in the *Label* field. 
.. Click in the *Name* field to populate it with the label name with underscores.
...
.. Click *New*, enter *Bypass Account Validation Rule* in the *Label* field, click in the *Name* field to populate it with the label name with underscores, and then click *Save*.
.. Click *Bypass Account Validation Rule* and click *Custom Permissions* from the *Apps* section.
.. Select *Bypass Account Validation* and click *Save*.
.. From *Object Manager*, select *Validation Rules*.
.. Select an object used for the validate rule and click *Edit*.
...
.. Click *Add Assignment*, select the user and click *Next*.
.. Click *Assign*.
