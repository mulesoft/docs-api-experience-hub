...
. Reload the page if the images aren't showing up.
...
To report issues or defects in API Experience Hub, submit a support case through the https://help.salesforce.com[Salesforce Help].
...
Service-level agreements (SLAs) for support are available at the https://www.salesforce.com/en-us/wp-content/uploads/sites/4/documents/legal/Agreements/mulesoft-cloud-offerings-SLA-forSalesforce-uMSA.pdf[MuleSoft Product Support and Maintenance Terms] page.
