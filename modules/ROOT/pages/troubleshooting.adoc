...
Validation rules cannot be applied to Salesforce standard objects, for example, account and user objects, that are created during the Salesforce linking process. 

The workaround is to bypass the validation rule for the Salesforce user who performs the linking process. 

NOTE: These instructions pertain to bypassing account object validation rules but can apply to bypassing custom validation rules of other objects. 
