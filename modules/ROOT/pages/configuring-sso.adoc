...
+
image::aeh-sso-32-digit-id.png["An example of the 32 digit located in the browser URL."] 
...
+ 
image::aeh-sso-mapped-anypoint-idp-id-attribute.png["An example of mapped anypoint_idp_id attribute.",width=90%]
. Save your changes.
...
+
image::aeh-sso-view-saml-setup-instructions.png["The button that shows the SAML setup instructions",width=30%]
...
+
image::aeh-sso-saml-setup-instructions-page.png["SAML instructions to set up the page",width=90%]
