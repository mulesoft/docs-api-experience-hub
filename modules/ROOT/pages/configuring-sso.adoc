...
aliases: sso-use-case-1.adoc, sso-use-case-2.adoc
...
* Review the information in  xref:gathering-set-upso.adoc[Gathering Set Up Information].
...
. From the *User management* page, click *Login settings*.
