...
If this single sign-on is already configured in Anypoint Platform, you must map the application to the identity provider for Anypoint Platform by adding and configuring a new custom attribute called anypoint_idp_id.   
...
. To map anypoint_idp_id to with the Anypoint Platform identity provider ID for Microsoft Azure SAML:
...
+
image::aeh-identity-provider-id-azure.png["An example of an identity provider ID in Access Management."]
.. Save your changes.
