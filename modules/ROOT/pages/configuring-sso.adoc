...
Create a new application for the API Experience Hub portal in the identity provider using Microsoft Entra ID. Microsoft Entra ID OpenID Connect isn't supported.
