...
* Review the information in  xref:before-you-begin-configuring-sso.adoc[Gathering Set Up Information].
...
NOTE: Skip this step if you don't have an identity provider already configured for Anypoint Platform.
