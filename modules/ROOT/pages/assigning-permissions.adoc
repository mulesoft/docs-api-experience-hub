...
Assign the API Experience Hub User Approver permission to enable a user to approve or reject pending registration requests and enable or disable member users only. This permission doesn't allow this user to perform any other operations for the portal. 

When accessing the *Manage your API portal* page, the user with this permission can access the following *User Management* pages:
...
. Select *Permissions* and click *Add permissions*.
. In the *Select permissions to add for this user* search box, enter *API Experience Hub Users Approver*, select the checkbox, and then click *Next*.
