...
. Click the MuleSoft icon (image:aeh-mulesoft-logo.png[2%,2%]) and select *Access Management*.
. Click *Users*, and select the username of the user that you want to add the API Experience Hub Administrator permission. 
