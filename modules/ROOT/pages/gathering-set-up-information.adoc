...
For more information about adding custom claims when the identity provider is already configured but not in the required format, see the following *Required Claims and Attributes for SSO* section. 
