...
Member users who have registered applications, can view the My Applications page. The page lists applications that hold a contract with an API. Each client application has a client ID, client secret, description, URL, redirect URIs, and grant types.
