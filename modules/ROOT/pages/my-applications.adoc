...
* Last updated
+
Displays the date and time of the last client secret reset, in your local timezone.
* Client Credentials
+
...
NOTE: After you reset the client secret, the *Last updated* field shows the reset date and time in your local timezone.
