...
From this page, you can see the application name, description, and the client credentials of an application.
...
You can view the instance URL for an API by clicking *View URL* and copy it by clicking the *Copy from clipboard* icon.
