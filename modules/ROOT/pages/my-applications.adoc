...
The *My Applications* page enables you to review the lists of applications that hold a contract with a service. Each client application has a client ID, client secret, description, URL, redirect URIs, and grant types.
