...
Before you can create your portal, ensure that you have read the instructions in xref:prerequisites.adoc[Prerequisites].

//* Familiarity with Anypoint Platform and Exchange, including the permissions to use both 
//* Anypoint Platform Organization
//* API Experience Hub Admin permission
//* Organization administrator with permissions in Anypoint
