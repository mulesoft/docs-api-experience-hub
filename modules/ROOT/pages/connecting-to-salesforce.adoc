...
== Connect Your First Salesforce Organization 
...
. From the *Welcome to API Experience Hub* page, click *Let's Start*.
...
== Connect a Another Salesforce Organization

Use the following steps to connect to another Salesforce organization after an initial connection.

. Navigate to Anypoint Platform, enter your username and password, and then click *Sign in*.
. From Anypoint Platform, select *API Experience Hub* from the list of products.
. Click *Connect to Salesforce*.
. From the *Connect to Salesforce* dialog, select an option from the *Environment* list:
+
* Production
+
* Sandbox
...
== Next Steps
When the connection to the Salesforce organization is complete, set up the portal. For more information, see xref:styling-your-api-portal.adoc[].
