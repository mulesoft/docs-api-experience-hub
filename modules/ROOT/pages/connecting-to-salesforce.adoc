...
. From the *Connect to Salesforce Experience Cloud* dialog, select *Production* from the *Environment* list.
...
. Click *Allow* to allow MuleSoft to access your data.
...
== Next Steps
When the connection is complete, you can xref:styling-your-api-portal.adoc[style your API portal].
