...
== Connect a New Salesforce Organization

Use the following steps to connect to a new Salesforce organization after an initial connection.
...
== Next Steps
When the connection to the Salesforce organization is complete, create a new portal or create a portal using the metadata from an existing portal. For more information, see xref:setting-up-an-api-portal.adoc[].
