...
* Read the instructions in xref:prerequisites.adoc[Prerequisites].
...
NOTE: Only an Organization Administrator, API Experience Hub Administrator, or a user with the AEH_Anypoint permission set can link organizations.
