...
* Ensure that you are a System Admin in the Salesforce organization that you are connecting with.
...
NOTE: Only an Organization Administrator or API Experience Hub Administrator can link organizations.
