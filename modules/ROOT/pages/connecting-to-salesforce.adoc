...
NOTE: Only an Organization Administrator, API Experience Hub Administrator, or a Salesforce user with the System Administrator profile or AEH_Anypoint permission set can link organizations.
