...
API Experience Hub has a Salesforce organization with Experience Cloud and a managed package that is installed in this organization. The managed package contains the components and data objects that interact with your Anypoint Platform organization.
...
IMPORTANT: Ensure that you link your Anypoint organization to the correct Salesforce organization. 

An instance of API Experience Hub connects to only one Anypoint Platform organization and one Salesforce organization.
