...
You might need to collaborate with your security team or other team members if you don't have access to this information. See xref:user-roles-permissions-and-profiles.adoc[] for information.

[[username-strategy]]
== Review the Username Assignment Strategy For a Shared Identity
...
== Review the Required Claims and Attributes API Experience Hub Uses for SSO
