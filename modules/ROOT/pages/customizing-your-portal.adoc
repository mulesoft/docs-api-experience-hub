...
From the *API management* page, the *Preview and publish your portal* link opens your site for editing each page in your portal, creating new pages, and adding and editing the components on each page.
