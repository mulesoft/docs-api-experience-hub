...
To view information about the Salesforce organization for your portal, from the *Manage your API portal* screen, click *Settings*. 

The Settings screen show the following information:
...
* *Disconnect your API portal* 
+
// IMPORTANT: This is a required step to complete at the end of the pilot. 
+
Disconnecting your API portal removes artifacts from the API Experience Hub database and unlinks Anypoint to your Salesforce organization so that you can create another API portal with a future release of API Experience Hub.
