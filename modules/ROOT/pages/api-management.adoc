...
From the *APIs in Exchange* tab, select an API from the list, click more options icon, and select *View in Exchange*.
...
== Next Steps
From User Management, you can view and manage members, see pending requests, and find user registration information..
