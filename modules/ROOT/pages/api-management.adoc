...
You can determine which version of an API a user can view in your portal. You can set the visibility to Administrators, Members, or Guest.
...
* Members 
+ 
Use this option if you want the version to be seen by logged-in members only.
* Guest
+
Use this option if you want the version to be publicly available to anyone.

If the visibility is Guest or Members, then consumer developers can see the new API version in the API Carousel of the portal.
