...
* *APIs in the portal*
+
Shows the APIs that have been added to your portal and includes a physical count of APIs. The default visibility for the APIs is Administrators only. The administrator of the portal can change this visibility for each API in the API Management tab. These APIs can also be removed.

* *APIs in Exchange*
+
Shows the APIs that exist in your Exchange organization but have not been added to your portal.

You can view the description of an API by clicking the down arrow of the API name in the list:
...
. Select an API from the list, click the three dots icon, and select *Add to portal*.
+
...
. To search for an API by name or description, enter the name or description into the *Search* bar.
. Select an API from the list, click the three dots icon, and select *Remove from portal*.
. Click *Confirm*.
+
...
. Select an API from the list, click the three dots icon, and select *Edit display details*.
. To change the API version visibility, select an option from the *Visibility* drop-down list for the corresponding version.
. Click *Save*.

== Next Steps
Use the xref:user-management.adoc[User management] page to view and manage users.
