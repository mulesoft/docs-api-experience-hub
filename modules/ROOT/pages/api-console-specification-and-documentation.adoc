...
The API Console displays the API specifications and documentation. An API’s specifications and documentation information are critical to the onboarding process and adoption. Developers need to know how to use and integrate APIs. 
