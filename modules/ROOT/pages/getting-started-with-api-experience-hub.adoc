...
* You must either have the System Administrator profile or be a Salesforce user with the AEH_Anypoint permission set assigned in the Salesforce organization that you're are connecting to during the linking process. For more information, see xref:assigning-permissions.adoc[].
+
