...
* You must be a System Administrator or a Salesforce user with the AEH_Anypoint permission set assigned in the Salesforce organization that you are linking to during the connection process. For more information about the AEH_Anypoint permission set, see 
+
