...
* You must have the System Administrator profile or a Salesforce user with the AEH_Anypoint permission set assigned in the Salesforce organization that you are connecting to during the linking process. For more information, see xref:assigning-permissions.adoc[].
+
...
If you do not have the required accounts and access, issues can occur during the Salesforce linking process when creating your API portal.
