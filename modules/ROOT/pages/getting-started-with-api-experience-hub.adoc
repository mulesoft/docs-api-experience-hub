...
+
The current package has a minimum of 100 services access requests which requires a minimum of 2000 External Identity licenses. 
...
+
Manage servcices by adding agents,APIs, LLMs, and MCP servers from Exchange and setting the visibility for the service versions. Manage users by approving access requests from guest users.
