...
Anypoint Platform comes with predefined roles and permissions that can be set in the Access Management to manage users with different access levels. API Experience Hub has permissions for administrators, consumers, and Exchange viewers.
