...
Anypoint Platform comes with predefined roles and permissions that you can set in Access Management to manage users with different access levels. API Experience Hub has permissions for administrators, consumers, and Exchange viewers.
...
* Manage users.
* Use Experience Builder to customize portal.|
API Experience Hub Portal Administrator| Currently, can manages only one API portal in the organization. 
a|
