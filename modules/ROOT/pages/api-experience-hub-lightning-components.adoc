...
Each API Experience Hub Lightning component has different configuration options and adds different functionality to the portal. API Experience Hub supports custom components in English only.
...
. Click the component on the page to show the component’s configuration options. 
...
Select *Expand endpoints* to show in the API Console.
...
Enter or select these properties to show in the *API details* page:
...
You can specify values for these Assets Carousel properties:
...
== Existing User Request Access
The Existing User Request Access component enables existing Salesforce users to access the portal by entering their username and clicking a button to request access.

Enter the properties to show in the component:
