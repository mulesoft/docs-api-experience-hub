...
The User Management page enables you to view and manage users and manage access requests from guest users. The ability for users to self-register for your portal is enabled by default.
...
//To configure a registration page for your portal members:
