...
By default, users have the ability to self-register to become a member and acccess your portal site. Administrator can enable To configure a registration page for your portal members:
