...
* Name
+
The first and last name of registered member.
* Email 
+
...
After a guest user registers for an account using self-registration, you receive a notification email. You can approve or reject the request.
