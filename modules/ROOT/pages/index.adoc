...
* Use Google Analytics to gain valuable insights into how consumers are using your APIs and portal
...
== Portal Pages
Each API Experience Hub portal includes a Home, APIs, and an API Details page. The portal administrator can customize each page to fit the organization's needs. For more information, see xref:setting-up-the-api-portal.adoc[].

The following sample portal shows the Home page: 

image::aeh-home-page.png["A portal showing the Home page"]
