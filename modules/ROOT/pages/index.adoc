...
== Portal Pages
Each API Experience Hub portal includes a Home, APIs page, and an API Details page. The portal administrator can customize each page to fit the organization's needs. For more information, see xref:setting-up-the-api-portal.adoc[].
