...
+
The process of creating the portal begins and can take several minutes. Once the portal is created, the site is live and accessible. To make the site unaccessible, see xref:deactivate-your-portal-site.adoc[Deactivate Your Portal Site] for more information.
