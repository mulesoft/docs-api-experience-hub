...
== Granular Permission and Permission Sets
...
|AEH_Anypoint permission set|This permission set contains the minimum permissions required for a Salesforce user to perform the linking process. 
a|
