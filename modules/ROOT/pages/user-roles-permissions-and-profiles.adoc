...
* For Anypoint Platform, users with different access level are managed using Access Management. You can configure the permissions for administrators and Exchange viewers. For more information, see xref:access-management::managing-permissions.adoc[Managing Permissions in Access Management]. 
