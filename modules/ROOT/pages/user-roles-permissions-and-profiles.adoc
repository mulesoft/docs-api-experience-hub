...
* For Anypoint platform, users with different access level are managed using Access Management. For more information, see xref:access-management::managing-permissions.adoc[Managing Permissions in Access Management]. 
* For Experience Cloud, the System Administrator profile is required for the user who performs the linking process. 
